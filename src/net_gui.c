...
static void CloseWindow(TXT_UNCAST_ARG(widget), TXT_UNCAST_ARG(p_window))
{
...
static void CheckSHA1Sums(void)
{
    ...
    TXT_SignalConnect(cont_button, "pressed", CloseWindow, l_window);
    ...
    if (!same_freedoom)
    {
        ...
        {
            TXT_AddWidget(l_window, TXT_NewLabel
