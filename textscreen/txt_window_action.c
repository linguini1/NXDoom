...
static void TXT_WindowActionMousePress(TXT_UNCAST_ARG(action), int x, int y,
                                       int b)
{
  TXT_CAST_ARG(txt_window_action_t, action);
...
static void WindowCloseCallback(TXT_UNCAST_ARG(widget),
...
static void WindowSelectCallback(TXT_UNCAST_ARG(widget),
                                 TXT_UNCAST_ARG(window))
{
  TXT_CAST_ARG(txt_window_t, window);
