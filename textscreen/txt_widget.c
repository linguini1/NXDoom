...
void TXT_RefCallbackTable(txt_callback_table_t *table) { ++table->refcount; }
...
int TXT_AlwaysSelectable(TXT_UNCAST_ARG(widget)) { return 1; }

int TXT_NeverSelectable(TXT_UNCAST_ARG(widget)) { return 0; }
